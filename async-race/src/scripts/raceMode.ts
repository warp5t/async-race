...
raceBtn.addEventListener('click', () => {
	...
	for (let i = lengthContainer - initCount - 1 + remainDiff; i < (lengthContainer - initCount) + (6 - lastDiffer); i++) {
		console.log(i, ' - i');
		
		// const crudeID = collectionTracks[i].id;
		// const pointUnit = Number(crudeID.slice(6, crudeID.length));
		// console.log(pointUnit, ' - pointUnit 142');	
	}
